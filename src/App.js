...
import SetIntervalCounter from './components/SetIntervalCounter';
function App() {
  ...
  */
  ...
  return (
    <div className="container">
      {isVisible && <SetIntervalCounter/>}
      <button className="btn" onClick={()=>setIsVisible(!isVisible)}>Toggle Visible</button>
     </div>
